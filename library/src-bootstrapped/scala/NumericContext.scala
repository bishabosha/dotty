...
case object NumericContext
  inline def fb: FromDigits.BigDecimalFromDigits.type = FromDigits.BigDecimalFromDigits
  inline def ib: FromDigits.BigIntFromDigits.type     = FromDigits.BigIntFromDigits
  inline def i8: ByteFromDigits.type                  = ByteFromDigits
  inline def i16: ShortFromDigits.type                = ShortFromDigits
  inline def u16: CharFromDigits.type                 = CharFromDigits
  inline def i32: IntFromDigits.type                  = IntFromDigits
  inline def i64: LongFromDigits.type                 = LongFromDigits
